...
/* ───────────── PROJETOS ───────────── */
function Projetos({ content }: { content: HomeContent }) {
  return (
    <section id="projetos" className="py-24 md:py-36 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
          {content.projectImages.map((proj, i) => (
...
/* ───────────── CTA FINAL ───────────── */
function CtaFinal({ content }: { content: HomeContent }) {
  return (
      ...
      <div className="max-w-4xl mx-auto text-center">
        <RevealSection>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href={`https://wa.me/${content.whatsappNumber}?text=Olá! Gostaria de solicitar um projeto.`}
              target="_blank"
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                +55 ({content.whatsappNumber.slice(2, 4)}) {content.whatsappNumber.slice(4, 9)}-{content.whatsappNumber.slice(9)}
              </a>
              <a
...
function WhatsAppButton({ content }: { content: HomeContent }) {
    ...
    <AnimatePresence>
      {visible && (
        <motion.a
          ...
          href={`https://wa.me/${content.whatsappNumber}?text=Olá! Gostaria de saber mais sobre os projetos Venatto.`}
          target="_blank"
          rel="noopener noreferrer"
...
export default function HomeClient({
  ...
  return (
    <main className="min-h-screen">
      ...
      <WhatsAppButton content={homeContent} />
      <BackToTop />
    </main>
  );
}